...
function button_Register()
{
    ...
    <div class="header-button">
        <?php if (pll_current_language() == 'vi') { ?>
            <a href="<?php echo home_url(); ?>/dang-ky-du-thi/" class="button primary" style="border-radius:99px;">
                <span>Đăng ký dự thi</span>
            </a>
        <?php } else if (pll_current_language() == 'en') { ?>
            <a href="<?php echo home_url(); ?>/register-to-compete/" class="button primary" style="border-radius:99px;">
...
add_shortcode('button_Register', 'button_Register');
