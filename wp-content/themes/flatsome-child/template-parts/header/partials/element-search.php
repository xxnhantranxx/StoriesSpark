...
<li class="header-search header-search-dropdown has-icon has-dropdown menu-item-has-children">
	...
	<a href="#" aria-label="<?php echo __('Search','woocommerce'); ?>" class="<?php echo get_flatsome_icon_class(get_theme_mod('search_icon_style'), 'small'); ?>"><img src="<?php echo get_stylesheet_directory_uri(); ?>/img/icons/icon_search.png" alt="Search" class="search-icon"></a>
