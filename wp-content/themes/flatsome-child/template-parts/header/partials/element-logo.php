...
$site_logo_sticky    = wp_get_attachment_image_src( $site_logo_sticky_id, 'full' );
$site_logo_dark      = wp_get_attachment_image_src( $site_logo_dark_id, 'full' );
...
$sub_logo_url        = get_field('url_logo_sub', 'option');
