...
<div class="row row-large <?php if(get_theme_mod('blog_layout_divider')) echo 'row-divided ';?>">
	...
	<?php
		if(is_single()){
			...
			get_template_part( 'template-parts/posts/archive', get_theme_mod('blog_style') );
		}
	?>
	</div>
