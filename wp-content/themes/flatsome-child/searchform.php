...
<form method="get" class="searchform" action="<?php echo esc_url( home_url( '/' ) ); ?>" role="search">
    <div class="_4rbj flex-row relative">
        ...
        <div class="_0von flex-col">
            <button type="submit" class="ux-search-submit submit-button button icon mb-0" aria-label="<?php esc_attr_e( 'Submit', 'flatsome' ); ?>">
                <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/icons/search_24px.png" class="_0xha">
            </button>
        </div>
    </div>
