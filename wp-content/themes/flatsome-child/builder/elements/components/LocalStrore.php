...
add_ux_builder_shortcode( 'LocalStrore', array(
    'name'      => __('Local Strore'),
    ...
    'options' => array(
        'settings_options' => array(
            ...
            'description' => 'Sửa trong quản trị Quản trị > <a target="blank" style="color:#9aa506" href="'.home_url().'/wp-admin/edit.php?post_type=local-store">Cửa hàng</a>',
            'options' => array(
                'class' => array(
                    'type' => 'textfield',
                    'heading' => 'Class',
