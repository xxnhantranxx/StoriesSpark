...
add_ux_builder_shortcode( 'Sun_SlideCard', array(
    'name'      => __('Slider Card'),
    ...
    'options' => array(
        'settings_options' => array(
            ...
            'description' => 'Sửa trong quản trị Tuỳ Chọn > <a target="blank" style="color:#9aa506" href="'.home_url().'/wp-admin/admin.php?page=video-card">Video Card</a>',
            'options' => array(
                'class' => array(
                    'type' => 'textfield',
                    'heading' => 'Class',
