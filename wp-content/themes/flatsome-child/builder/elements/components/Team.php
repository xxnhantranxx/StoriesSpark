...
$link_img = home_url().'/wp-content/themes/flatsome-child/img/admin/icon-builder/message_box.svg';
add_ux_builder_shortcode( 'Team', array(
    'name'      => __('Team'),
    ...
    'options' => array(
        'settings_options' => array(
            ...
            'description' => 'Sửa trong quản trị Tuỳ Chọn > <a target="blank" style="color:#9aa506" href="'.home_url().'/wp-admin/admin.php?page=team">Team</a>',
            'options' => array(
                'class' => array(
                    'type' => 'textfield',
                    'heading' => 'Class',
