        ...
        <table class="form-table">
            ...
            <tr>
                ...
                <td>
                    ...
                    <small class="dvls_description"><?php printf(__('%1$sHow to create a google maps api?%2$s','devvn-local-store'),'<a href="https://levantoan.com/create-google-maps-api/" target="_blank" title="">','</a>'); //phpcs:ignore WordPress.WP.I18n.MissingTranslatorsComment?></small>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    ...
                    <small class="dvls_description"><?php printf(__('%1$sAuto Get Latitude and Longitude%2$s','devvn-local-store'),'<a href="https://levantoan.com/auto-get-latitude-longitude/" target="_blank" title="">','</a>'); //phpcs:ignore WordPress.WP.I18n.MissingTranslatorsComment?></small>
                </td>
            </tr>
            <tr>
