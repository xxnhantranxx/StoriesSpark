        ...
        <div class="dvls_maps_row dvls_maps_header">
            ...
            <div class="dvls_maps_header_right">
                <form action="" method="get">
                    ...
                    <div class="dvls_maps_col">
                        <a href="javascript:void(0);" class="dvls_near_you" title="<?php printf(__('Find a store near you (<=%s km)','devvn-local-store'),$dvls_settings['radius']);//phpcs:ignore WordPress.WP.I18n.MissingTranslatorsComment?>"><?php printf(__('Find a store near you (<=%s km)','devvn-local-store'),$dvls_settings['radius']); //phpcs:ignore WordPress.WP.I18n.MissingTranslatorsComment?></a>
                    </div>
                </form>
            </div>
        </div>
