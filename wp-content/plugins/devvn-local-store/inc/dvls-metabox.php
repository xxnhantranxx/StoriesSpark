    ...
    <div class="dvls-col-left">
        <table>
            <tr>
                ...
                <td><input type="text" name="dvls[name]" id="dvls_name" value="<?php echo esc_attr($dvls_data['name'])?>"/></td>
            </tr>
            <tr>
                <td class="dvls_label"><?php _e('Address','devvn-local-store')?></td>
                <td><input type="text" name="dvls[address]" id="dvls_address" value="<?php echo esc_attr($dvls_data['address'])?>"/></td>
            </tr>
            <tr style="display: none">
                ...
                <td>
                    <div class="dvls-two-col">
                        <div class="dvls-col-left">
                            <select name="dvls[city]" class="dvls_city" data-value="<?php echo esc_attr($dvls_data['city'])?>">
                                <option value="null"><?php _e('Select city','devvn-local-store')?></option>
                            </select>
                        </div>
                        <div class="dvls-col-right">
                            <select name="dvls[district]" class="dvls_district" data-value="<?php echo esc_attr($dvls_data['district'])?>">
            ...
            <tr>
                ...
                <td><input type="text" name="dvls[phone1]" id="dvls_phone1" value="<?php echo esc_attr($dvls_data['phone1'])?>"/></td>
            </tr>
            <tr>
                <td class="dvls_label"><?php _e('Phone number 2','devvn-local-store')?></td>
                <td><input type="text" name="dvls[phone2]" id="dvls_phone2" value="<?php echo esc_attr($dvls_data['phone2'])?>"/></td>
            </tr>
            <tr>
                <td class="dvls_label"><?php _e('Hotline 1','devvn-local-store')?></td>
                <td><input type="text" name="dvls[hotline1]" id="dvls_hotline1" value="<?php echo esc_attr($dvls_data['hotline1'])?>"/></td>
            </tr>
            <tr>
                <td class="dvls_label"><?php _e('Hotline 2','devvn-local-store')?></td>
                <td><input type="text" name="dvls[hotline2]" id="dvls_hotline2" value="<?php echo esc_attr($dvls_data['hotline2'])?>"/></td>
            </tr>
            <tr>
                <td class="dvls_label"><?php _e('Email','devvn-local-store')?></td>
                <td><input type="text" name="dvls[email]" id="dvls_email" value="<?php echo esc_attr($dvls_data['email'])?>"/></td>
            </tr>
            <tr>
                <td class="dvls_label"><?php _e('Open','devvn-local-store')?></td>
                <td><input type="text" name="dvls[open]" id="dvls_open" value="<?php echo esc_attr($dvls_data['open'])?>"/></td>
            </tr>
            <tr>
                ...
                <td>
                    ...
                    <div class="svl-upload-image <?php if($imgid):?>has-image<?php endif;?>">
                        <div class="view-has-value">
                            <input type="hidden" class="clone_delete" name="dvls[marker]" id="maps_marker_icon" value="<?php echo esc_attr($imgid);?>"/>
        ...
        <table>
            ...
            <tr>
                <td>
                    ...
                    <input name="dvls[maps_lat]" id="dvls_maps_lat" value="<?php echo esc_attr(($dvls_data['maps_lat'])?$dvls_data['maps_lat']:$dvls_settings['lat_default'])?>" placeholder="<?php _e('lat coordinate','devvn-local-store')?>"/>
                </td>
                <td>
                    <label for="dvls_maps_lng"><?php _e('Longitude','devvn-local-store')?></label>
                    <input name="dvls[maps_lng]" id="dvls_maps_lng" value="<?php echo esc_attr(($dvls_data['maps_lng']) ? $dvls_data['maps_lng']: $dvls_settings['lng_default'])?>" placeholder="<?php _e('long coordinate','devvn-local-store')?>"/>
                </td>
            </tr>
            <tr>
                <td colspan="2">
                    <div id="dvls_maps" data-lat="<?php echo esc_attr(($dvls_data['maps_lat'])?$dvls_data['maps_lat']:$dvls_settings['lat_default'])?>" data-lng="<?php echo esc_attr(($dvls_data['maps_lng']) ? $dvls_data['maps_lng']: $dvls_settings['lng_default'])?>"></div>
